...
class _CoachChatPopupState extends State<CoachChatPopup> {
  ...
  void initState() {
    ...
    _messages.add(ChatMessage(
      text: lang.text(
        'สวัสดีครับ 👋 ผมคือ AI Coach มีอะไรให้ช่วยเรื่องการวิ่งหรือการฝึกบ้างครับ',
        'Hello! 👋 I am your AI Coach. How can I help you with your running or training today?',
      ),
      isUser: false,
    ));
  }
  ...
  Widget _panel(LanguageController lang, {Key? key}) => Column(
        key: key,
        children: [
          Container(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(lang.text('AI โค้ช', 'AI Coach'), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w800)),
                      Text(
                        lang.text('ผู้ช่วยฝึกวิ่งของคุณ', 'Your Personal Running Coach'),
              ...
              itemBuilder: (_, i) {
                ...
                return Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: m.isUser ? AppColors.primary : AppColors.background,
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: lang.text('พิมพ์ข้อความ...', 'Type a message...'),
                      isDense: true,
                      filled: true,
